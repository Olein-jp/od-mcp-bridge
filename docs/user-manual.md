...
このマニュアルの内容に対応するバージョンは `0.5.0` です。現在の配布ファイルは
[od-mcp-bridge-0.5.0.zip](https://github.com/Olein-jp/od-mcp-bridge/releases/download/0.5.0/od-mcp-bridge-0.5.0.zip)
から取得できます。
